 ...
 */
extern void RTC_GetTimeAndDate( Rtc* pRtc, uint8_t* pucPM, uint8_t *pucHour, uint8_t *pucMinute, uint8_t *pucSecond, uint16_t *pwYear, uint8_t *pucMonth, uint8_t *pucDay, uint8_t *pucWeek );
